...
>If you want to code the clock using the online editor trinket.strivemath.org you will find the instructions for making the digital clock will work almost exactly the same, but for the analogue clock you should look for the ***special trinket instructions in Step 3***.
